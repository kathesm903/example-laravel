...
<div class="container py-5 text-center">
    ...
    @endif
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="due" class="form-control" placeholder="Saldo del Cliente" value="{{ old('due') ?? @$client->due }}">
        ...
        <div class="mb-3">
            ...
            <p class="form-text"> Ingrese los comentarios que desee</p>
            @error('comments')
            <p class="form-text text-danger"> {{ $message }}</p>
            @enderror
